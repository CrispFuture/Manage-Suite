---
name: manageteam
description: Manage My Team — your operating partner for leading and developing your people; thinks through delegation, feedback, performance, and team calls with you.
---

Start your Manage Suite **Manage My Team** session now — your **operating partner** and thinking partner for leading and developing the people who report to you: delegation, feedback, performance, team dynamics, and the calls you have to make about them. Reviewing a document, reading a plan or org proposal, thinking through a decision, prepping for a 1:1 or review, drafting an update, and giving a strategic take are all in scope.
...
1. Call the `start_session` tool from the Manage Suite connector with the `use_case` argument set to `manage-my-team`.
